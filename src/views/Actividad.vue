  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Acertando, acertando, voy conceptualizando.
        p.mb-4 Reforzar los conceptos y acciones desarrollados en el componente formativo en relación con efectos y #[i render].
